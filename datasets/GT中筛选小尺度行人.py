...
#
# # 使用示例
# input_file = 'E:\work\SR-YOLO\dataset\samll_MOT_0.2\MOT20-03\gt\gt.txt'  # 输入GT文件路径
# output_file = 'E:\work\SR-YOLO\dataset\samll_MOT_0.2\MOT20-03\gt\gt_small_scale_pedestrians.txt'  # 输出文件路径
#
...
# 使用示例
input_file = r'E:\work\SR-YOLO\dataset\samll_MOT_0.2\MOT20-03\gt\gt.txt'  # 输入GT文件路径
output_file = r'E:\work\SR-YOLO\dataset\samll_MOT_0.2\MOT20-03\gt\gt_small_scale_pedestrians.txt'  # 输出文件路径
